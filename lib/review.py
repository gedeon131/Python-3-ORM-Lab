...
class Review:
    ...
    def summary(self, value):
        ...
        if len(value.strip()) == 0:   # vide ou juste espaces
            raise ValueError("summary must have length > 0")
        self._summary = value
    ...
    def save(self):
        ...
        if self.id is None:
            ...
            self.update()  # Met à jour si déjà existant
    ...
    def instance_from_db(cls, row):
        ...
        if review_id in cls.all:
            ...
            review = cls(year, summary, employee, id=review_id)
    ...
    def update(self):
        ...
        if not self.id:
            raise Exception("Impossible de mettre à jour une Review non sauvegardée en base.")
